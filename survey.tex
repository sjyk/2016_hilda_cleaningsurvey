...
\note{\url{http://TODO}}
 ...
 \dhaas{As the survey data captured via the methods described above is insufficient to draw statistically significant quantitative conclusions, our subsequent analysis is purely qualitative and designed to present insightful comments that illustrate the sentiments of our respondents. do folks think this is too much self-hate? Other caveats we should present here?}
